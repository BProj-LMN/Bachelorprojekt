...
using namespace std;
double istX,istY,istZ,sollX,sollY,sollZ;
DCB serialconfig;
DWORD iBytesWritten;
...
int main(int argc, char** argv) {
    ...
    trajec.calcCheckpoints(istX,istY,istZ,sollX,sollY,sollZ);
    ...
    do{
        ...
        if(trajec.checkpointReached(istX,istY,istZ)){ //wenn ceckpoint erreicht
